...
<!-- Navigation -->
<nav style=" height: 5vh; background-color: lightgrey;">
    <div class="container ">
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav" style="width:100%; margin: auto; text-align: center;">
                <li><a href="#quest" style="color: black; font-weight: bold; font-size: 2.5rem;"> فتح محادِثة جديدة</a></li>
            </ul>
        </div>
    </div>
</nav>
