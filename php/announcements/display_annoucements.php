    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="update_annoucements.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row" style="margin-bottom: 1rem;">
                        ...
                        <div class="value" style="widows: 100; margin: auto;">
                            <div class="input-group">
                                <textarea id="body" class="textarea--style-6" rows="5" cols="40" name="body" style="background-color: lightsteelblue; width: 100%;" required></textarea>
                            </div>
                        </div>
                    </div>

                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" style="font-size: 1.7rem;">إقفال</button>
                        <button type="submit" name="updatedata" class="btn btn-danger" style="font-size: 1.7rem;">تعديل</button>
                    </div>
                </form>
            </div>
        </div>
...
<!--Delete Modal -->
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="width: 100% !important; margin: auto;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" style="font-size: 2rem;">محو الإعلان</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="delete_announcement.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="delete_id" id="delete_id">
                    <h4 style="margin: .5rem; padding: .5rem; text-align: right; font-size: 2rem;">هل أنت متأكد أنك تريد محو هذا الإعلان ؟</h4>

                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" style="font-size: 2rem;">كلا</button>
                        <button type="submit" name="deletedata" class="btn btn-danger" style="font-size: 2rem;">!نعم</button>
                    </div>
                </form>
            </div>
        </div>
							...
							while($row = $results->fetch_assoc()) {
                                ...
                                <tr style="height: 15vh; font-size: 1.2rem;">
                                    ...
                                    <td style="font-size: 2rem;">
										...
										<?php if ($_SESSION['adminUserName'] == $row['addedBy']) {?>
                                            <button type="button" class="btn btn-success editbtn" style="font-size: 1rem; padding: .5rem;">تعديل الإعلان</button>
                                            <button type="button" class="btn btn-danger deletebtn" style="font-size: 1rem; padding: .5rem;">محو الإعلان</button>
										<?php } else {}?>
                                    </td>
                                </tr>
                                </tbody>
